...
units = {
    ...
    "militia_brigade": "militia regiment",
    "Communist_militia_brigade": "communist militia regiment",
    "fascist_militia_brigade": "fascist militia regiment",
    "police_brigade": "military police regiment",
    "conscript_brigade": "conscript regiment",
    "partisan_brigade": "partisan regiment",
    ...
    "colonial_militia_brigade": "colonial militia regiment",
    ...
    "medium_artillery_brigade": "medium artillery regiment",
    "heavy_artillery_brigade": "heavy artillery regiment",
    "pack_artillery_brigade": "mountain artillery regiment",
    "rocket_artillery_brigade": "rocket regiment",
    ...
    "engineer_brigade": "engineer regiment",
    "motorized_engineer_brigade": "motorized engineer regiment",
    "armored_engineers_brigade": "armored engineer regiment",

    "airborne_engineer_bat": "airborne engineer regiment",
    "airborne_artillery_brigade": "airborne artillery regiment",
    "airborne_combined_arms_brigade": "airborne support regiment",

    "mixed_support_brigade": "mixed support regiment",
    "motorized_support_brigade": "motorized support regiment",
    "armored_support_brigade": "armored support regiment",

    "anti_tank_brigade": "anti tank regiment",
    "heavy_anti_tank_brigade": "heavy anti tank regiment",
    ...
    "heavy_tank_destroyer_brigade": "heavy tank destroyer regiment",
            ...
            with open(os.path.join(path, file), 'r', errors='ignore') as data:
                ...
                if file[:-4] in languages:
                    ...
                    for key in units:
                        ...
                        if(("\t" + key + " ") in text[unitNameStart:unitNameEnd] or ("\n" + key + " ") in text[unitNameStart:unitNameEnd]):
