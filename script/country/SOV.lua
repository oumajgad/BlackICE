...
function P.LandTechs(voTechnologyData)
	...
	if lbArmor then
		ignoreTech = {
			...
			{"NKVD_increase", 2},
			{"Guards_infantry_increase", 2},
			{"Guards_special_forces_increase", 2},
			{"Guards_mobile_increase", 2},
			{"Guards_armor_increase", 2},
			{"Guards_artillery_increase", 2},
			{"NKVD_decrease", 0},
...
function P.Build_armor_brigade(vIC, viManpowerTotal, voType, voProductionData, viUnitQuantity)
	...
	if voProductionData.humanTag == sovTag then
		...
		voType.fourth = "medium_tank_destroyer_brigade"
		voType.Support = 0
		voType.SupportVariation = 0
