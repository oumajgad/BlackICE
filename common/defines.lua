...
military = {
	...
	AIR_COMBAT_NAV_SURPRISE_BONUS = 0.5, -- Naval bomber surprise attack bonus
	...
	NAVAL_COMBAT_STR_DAMAGE_MODIFIER = 0.25, -- Average Strength damage is a bit higher and there will be much more randomness in it!
	NAVAL_COMBAT_SUB_SURPRISE_CHANCE = 55, -- Chance of attacking subs getting a surprise bonus (%)
	NAVAL_COMBAT_SUB_SURPRISE_BONUS = 16, -- Sub surprise attack bonus
	...
	NAVAL_STACK_POS_PENALTY_MAX = 1.8, -- maximum possible penalty due to size/positioning
	...
	CAG_SHIP_ATTACK_STR_BONUS = 6, -- attack bonus if CAG attacks ships who are busy in combat
	CAG_SHIP_ATTACK_ORG_BONUS = 7.5,
