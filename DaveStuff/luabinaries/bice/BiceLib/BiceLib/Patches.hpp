...
namespace Patches {
    inline bool patchBytes(void* address, BYTE values[], int len) {
        ...
        DWORD protection;
        VirtualProtect(address, len, PAGE_EXECUTE_READWRITE, &protection);
        ...
        DWORD trash;
        VirtualProtect(address, len, protection, &trash);
        return 1;
	}
    ...
    inline bool patchMinisterTechDecay(uintptr_t moduleBase) {
        ...
        patchBytes((void*)address1, one, 1);
        return 1;
    }
