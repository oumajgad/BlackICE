...
military = {
	...
	NAVAL_COMBAT_ORG_DAMAGE_MODIFIER = 0.3, -- Average damage is the same, but it will be more consistent with less randomness.
	...
	NAVAL_STACK_POS_PENALTY_HULL_MULT = 0.3, 	-- Every hull point above the limit gives this positioning penalty
	...
	CAG_SHIP_ATTACK_STR_BONUS = 15, -- attack bonus if CAG attacks ships who are busy in combat
	CAG_SHIP_ATTACK_ORG_BONUS = 4,
