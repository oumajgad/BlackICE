...
military = {
	...
	AIR_COMBAT_NAV_SURPRISE_CHANCE = 20, -- Chance of attacking naval bombers getting a surprise bonus (%)
	AIR_COMBAT_NAV_SURPRISE_BONUS = 5, -- Naval bomber surprise attack bonus
	...
	NAVAL_COMBAT_SUB_SURPRISE_CHANCE = 15, -- Chance of attacking subs getting a surprise bonus (%)
