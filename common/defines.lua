...
country = {
	...
	DEMOBILIZATION_FACTOR = 1, -- The amount of manpower you get back from units when demobilizing.
	...
	SPY_COVERT_OPS_GAIN = 0.65, -- monthly gain per spy
	SPY_COVERT_OPS_MAX = 75,
	COUP_COVERT_OPS_COST = 30,
...
military = {
	...
	ENVELOPMENT_PENALTY = 0.2,	-- envelopment penalty, for each direction.
	ENCIRCLED_PENALTY = 0.5,	-- for completely encircled units.
	DIG_IN_FACTOR = 0.04,	-- dig-in factor.
	COMBAT_SUPPLY_LACK_IMPACT = 0.35,	--combat penalty factor on lack of supplies.
	COMBAT_DISSENT_IMPACT = 1.5,	-- dissent modifier in combat.
	...
	EXP_GAIN_LAND = 0.2,	--was 0.55 unit/25 leader	is 0.55 unit/15.6 leader
	EXP_GAIN_NAVAL = 1.25,	--was 2.2 unit/100 leader	is 2.2 unit/62.5 leader
	EXP_GAIN_AIR = 1.25,	--was 2.2 unit/100 leader	is 2.2 unit/62.5 leader
	EXP_GAIN_DIV = 1.65,	--was 1.1
	EXP_GAIN_LEADER = 50.0,
	...
	BOMB_SHIP_DAMAGE_MODIFIER = 0.8, -- bombing ships #was 0.8
	BOMB_WING_DAMAGE_MODIFIER = 40, -- bombing airplanes (on ground)
	OFFICER_COMBAT_LOSS = 0.034,
	AGGRESSIVE_ORGANISATION_LIMIT = 0.3,
	DEFENSIVE_ORGANISATION_LIMIT = 0.7,
	PASSIVE_ORGANISATION_LIMIT = 0.9,
	AGGRESSIVE_STRENGTH_LIMIT = 0.3,
	DEFENSIVE_STRENGTH_LIMIT = 0.7,
	PASSIVE_STRENGTH_LIMIT = 0.9,
	CAG_DUTY_MINIMUM_ORG_LIMIT = 0.4,
	LAND_COMBAT_THREAT_IMPACT = 0.025,
	NAVAL_COMBAT_THREAT_IMPACT = 0.005,
	AIR_COMBAT_THREAT_IMPACT = 0.005,
	BOMBING_THREAT_IMPACT = 0.005,
	LAND_DOCTRINE_INCREASE = 0.001,
	NAVAL_DOCTRINE_INCREASE = 0.01,
	AIR_DOCTRINE_INCREASE = 0.01,
	BOMBING_DOCTRINE_INCREASE = 0.01,
	COMBAT_DIFFICULTY_IMPACT = 0.15,
	BASE_COMBAT_WIDTH = 1800,
	ADDITIONAL_COMBAT_WIDTH = 400,
	...
	AIR_COMBAT_NAV_SURPRISE_CHANCE = 5, -- Chance of attacking naval bombers getting a surprise bonus (%)
	...
	NAVAL_COMBAT_SUB_SURPRISE_CHANCE = 35, -- Chance of attacking subs getting a surprise bonus (%)
	...
	AMPHIBIOUS_INVADE_DEFEND_LOW = 1, -- low and high cap of defend modifier scale. Scale interpolated by invasion progress.
	...
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.8, -- damage reduction if armor outclassing enemy
...
diplomacy = {
	...
	LEAVE_ALLIANCE_INFLUENCE_COST = 1,
	GUARANTEE_INFLUENCE_COST = 3.0,
	REVOKE_GUARANTEE_INFLUENCE_COST = 1,
	CALLALLY_INFLUENCE_COST = 1,
	NAP_INFLUENCE_COST = 5.0,
	PURCHASE_INFLUENCE_COST = 0.0,
	EMBARGO_INFLUENCE_COST = 3.0,
	MILACCESS_INFLUENCE_COST = 1,
	INFLUENCE_INFLUENCE_COST = 0.5,
	RELATION_INFLUENCE_COST = 1,
	...
	ALIGN_INFLUENCE_COST = 1,
	EMBARGO_RELATION_CHANGE = -200.0,
	EMBARGO_NETRALITY = 50.0,
	EMBARGO_THREAT_COST = 1,
	...
	TRADE_INFLUENCE_COST = 1,
	TRADE_CANCEL_INFLUENCE_COST = 0.0,
	TRADE_CANCEL_RELATION_COST = 10.0,
	EXPEDITION_INFLUENCE_COST = 0.0,
	EXPEDITION_RETURN_TIME = 1,
	EXPEDITION_RECLAIM_TIME = 1,
	LICENCE_INFLUENCE_COST = 1,
	ALLOW_DEBT_INFLUENCE_COST = 1,
	REVOKE_DEBT_INFLUENCE_COST = 1,
	YEARS_TO_REPAY_DEBT = 50.0,
	INFLUENCE_UPKEEP = 1,
	REGULAR_CONSTRUCTION_THREAT_IMPACT = 0.035,
	NEUT_INCREASE_DIFF_CONTINENT = 20,
	NEUT_REDUCTION_AT_CLAIMS = 20,
	SHARE_TECH_INFLUENCE_COST = 1,
	SHARE_TECH_LEADERSHIP_COST = 1,
...
weather = {
	...
	MUDDYNESSMOVEMENTMODIFIER 			= -0.75,	--Works like a gradient
	COLDMOVEMENTMODIFIER				= -0.5,	--Works as On/Off
