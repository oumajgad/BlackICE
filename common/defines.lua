...
military = {
	...
	NAVAL_COMBAT_STR_DAMAGE_MODIFIER = 0.4, -- Average Strength damage is a bit higher and there will be much more randomness in it!
	NAVAL_COMBAT_SUB_SURPRISE_CHANCE = 40, -- Chance of attacking subs getting a surprise bonus (%)
