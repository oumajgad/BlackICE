...
military = {
	...
	AIR_COMBAT_NAV_SURPRISE_CHANCE = 40, -- Chance of attacking naval bombers getting a surprise bonus (%)
	AIR_COMBAT_NAV_SURPRISE_BONUS = 0.35, -- Naval bomber surprise attack bonus
	...
	NAVAL_COMBAT_SUB_SURPRISE_CHANCE = 100, -- Chance of attacking subs getting a surprise bonus (%)
	NAVAL_COMBAT_SUB_SURPRISE_BONUS = 100, -- Sub surprise attack bonus
