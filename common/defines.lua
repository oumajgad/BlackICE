...
military = {
	...
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 1.00,
	...
	NAVAL_COMBAT_CRITICAL_HIT_DAMAGE_CHANCE = 8,
	...
	CAG_SHIP_ATTACK_STR_BONUS = 3, -- attack bonus if CAG attacks ships who are busy in combat
	CAG_SHIP_ATTACK_ORG_BONUS = 3.75,
