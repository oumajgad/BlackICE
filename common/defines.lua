...
military = {
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.3,
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.75,
	...
	NAVAL_COMBAT_SUB_SURPRISE_BONUS = 6, -- Sub surprise attack bonus
