...
military = {
	...
	EXP_GAIN_LAND = 0.312,	--was 0.55 unit/25 leader	is 0.55 unit/15.6 leader
	...
	NAVAL_COMBAT_SUB_SURPRISE_BONUS = 30, -- Sub surprise attack bonus
...
weather = {
	...
	COLDMOVEMENTMODIFIER				= -0.50,	--Works as On/Off
