...
military = {
	...
	NAVAL_STACK_POS_HULL_LIMIT = 27,		-- Total Hull size up to this is fine before taking stacking penalty
	...
	CAG_SHIP_ATTACK_STR_BONUS = 10, -- attack bonus if CAG attacks ships who are busy in combat
