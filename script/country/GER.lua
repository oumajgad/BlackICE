...
function P.LandTechs(voTechnologyData)
	...
	if lbArmor then
		ignoreTech = {
			...
			{"SS_guards_security_increase", 0},
			{"SS_guards_infantry_increase", 0},
			{"SS_guards_special_forces_increase", 0},
			{"SS_guards_mobile_increase", 0},
			{"SS_guards_armor_increase", 0},
			{"SS_guards_artillery_increase", 0},
			{"SS_guards_armorsupport_increase", 0},
			{"SS_guards_aa_at_increase", 0},
			{"SS_guards_engineers_increase", 0},
			{"SS_guards_security_decrease", 0},
			{"SS_guards_infantry_decrease", 0},
			{"SS_guards_special_forces_decrease", 0},
			{"SS_guards_mobile_decrease", 0},
			{"SS_guards_armor_decrease", 0},
			{"SS_guards_artillery_decrease", 0},
			{"SS_guards_armorsupport_decrease", 0},
			{"SS_guards_aa_at_decrease", 0},
			{"SS_guards_engineers_decrease", 0},
		...
		ignoreTech = {
			...
			{"SS_guards_security_increase", 0},
			{"SS_guards_infantry_increase", 0},
			{"SS_guards_airborne_increase", 0},
			{"SS_guards_mountain_increase", 0},
			{"SS_guards_mobile_increase", 0},
			{"SS_guards_armor_increase", 0},
			{"SS_guards_artillery_increase", 0},
			{"SS_guards_armorsupport_increase", 0},
			...
			{"SS_guards_security_decrease", 0},
			{"SS_guards_infantry_decrease", 0},
			{"SS_guards_airborne_decrease", 0},
			{"SS_guards_mountain_decrease", 0},
			{"SS_guards_mobile_decrease", 0},
			{"SS_guards_armor_decrease", 0},
			{"SS_guards_artillery_decrease", 0},
			{"SS_guards_armorsupport_decrease", 0},
...
function P.NavalTechs(voTechnologyData)
	...
	local preferTech = {
		...
		"capital_ship_bulkheads_thickness",
...
function P.Build_armor_brigade(vIC, viManpowerTotal, voType, voProductionData, viUnitQuantity)
	...
	if voProductionData.humanTag == sovTag then
		voType.TransportMain = "hftrack_transport"
		voType.TertiaryMain = "division_hq_standard"
		voType.first = "mechanized_brigade"
...
function P.Build_heavy_armor_brigade(vIC, viManpowerTotal, voType, voProductionData, viUnitQuantity)
	...
	if voProductionData.humanTag == sovTag then
		...
		voType.TertiaryMain = "division_hq_veteran"
		voType.second = "sp_artillery_brigade"
		voType.third = "heavy_tank_destroyer_brigade"
		voType.fourth = "armored_engineers_brigade"
		voType.Support = 0
		voType.SupportVariation = 0
	end
...
function P.Build_light_armor_brigade(vIC, viManpowerTotal, voType, voProductionData, viUnitQuantity)
		...
		voType.TransportMain = "truck_transport"
		voType.TertiaryMain = "division_hq_standard"
		voType.first = "motorized_brigade"
		voType.second = "artillery_brigade"
		voType.fourth = "motorized_engineer_brigade"
